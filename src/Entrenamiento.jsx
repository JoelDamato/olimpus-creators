  ...
  useEffect(() => {
    const handleMessage = (event) => {
      try {
        ...
        // Verifica si el mensaje es de PandaVideo y contiene el tiempo actual del video
        if (data.message === "panda_timeupdate") {
          console.log(`Tiempo actual del video: ${data.currentTime}s`)

          // Si el video ha llegado al minuto 7:30 (450s), desbloquea la sección
          if (data.currentTime >= 450) {
            setIsUnlocked(true)
          }

          // Si el video ha llegado al minuto 16:15 (975s), desbloquea el bonus
          if (data.currentTime >= 975) {
            setShowExtraContent(true)
          }
        }
      } catch (error) {
        console.error("Error procesando el mensaje del video:", error)
      }
    }
    ...
    <>
      ...
      >
        ...
        <h2 className="text-md md:text-2xl text-white text-center font-medium px-4">
          Para trabajar digital en 2025 no necesitas miles de seguidores ni invertir en publicidad, este es el camino
          más rápido...
        </h2>
          ...
          <>
            ...
            <div className="bg-white rounded-2xl max-w-4xl w-[90%] p-2 md:p-6 mx-5 shadow-lg mt-7">
              <div>
                <section className="w-full max-w-4xl mt-2 bg-white">
                  ...
                  <div className="flex flex-col items-center text-center p-6 w-11/12 md:w-3/4 mx-auto">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex md:flex-row items-center justify-between md:mt-8">
                        <p className="text-lg md:text-2xl font-bold flex-grow ">
                          Comenzar tu negocio digital en los próximos 30 días sin margen de error sin dejar de hacer lo
                          que estás haciendo hoy en día.
                        </p>
                  ...
                  <div
                    className={` z-[99999] pointer-events-auto fixed bottom-0 left-1/2 transform -translate-x-1/2 bg-black text-white p-4 shadow-lg w-full max-w-md text-center ${isVisible ? "block" : "hidden"}`}
                  >
                    ...
                    <p className="text-sm">
                      Si la formacion no es lo que esperabas, te rembolsamos el 100% de tu dinero, sin preguntas.
                    </p>
                  </div>
                </section>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex  md:flex-row rounded-lg ">
                  ...
                  <img
                    src="/trofeo.png"
                    alt="Trofeo"
                    className="w-10 z-100000 ml-8 absolute right-6 mt-20 md:w-[10rem] rounded-md mb-3 mx-auto"
                  />
              ...
              <div className="flex flex-col gap-5 p-5 justify-center items-center mb-5">
                ...
                <div className="flex  md:flex-row gap-5 items-center">
                  ...
                  <div className="text-left text-black tracking-wider">
                    ...
                    <p className="text-sm">
                      Descubre las necesidades de tu audiencia y crea el curso perfecto para vender de forma rápida y
                      sencilla.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex  md:flex-row gap-5 items-center">
                  ...
                  <div className="text-left text-black tracking-wider">
                    ...
                    <p className="text-sm">
                      Con el estudio de mercado, descubre los problemas de tu audiencia y prospecta de forma segura a tu
                      primer influencer.
                    </p>
                  </div>
                </div>
                ...
                <div id="hide-section" className="flex  md:flex-row gap-5 items-center">
                  ...
                  <div className="text-left text-black tracking-wider">
                    ...
                    <p className="text-sm">
                      Asegura tu lanzamiento haciendo que tu profesional cumpla con todo lo necesario para un
                      lanzamiento 100% exitoso.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex  md:flex-row gap-5 items-center">
                  ...
                  <div className="text-left text-black tracking-wider">
                    ...
                    <p className="text-sm">Aprovecha la experiencia de nuestra comunidad para potenciar tu negocio.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="bonusSection" className="flex justify-center items-center relative w-[100%] mt-4 mb-2">
              ...
              >
                <div className="bg-[#f9bc66]/80 w-11/12 md:w-1/2 p-2 rounded-3xl mt-5 md:p-5">
                  <h1 className="text-3xl md:text-4xl font-bold p-1 tracking-wider ">BONUS TEMPORALES</h1>
                ...
                >
                  ...
                  <span className="text-xs md:text-lg block">
                    Estas 2 herramientas pueden cambiar TODO en tu negocio
                  </span>
                </button>
              </div>
            </div>
            ...
            {showExtraContent && (
              <div className="fixed bottom-4 bg-white right-0 p-3 rounded-full shadow-lg transition-opacity duration-300">
                      <a
                      href="https://api.whatsapp.com/send?phone=5493516361261&text=Hola,%20quiero%20inscribirme%20al%20entrenamiento%20Go%20Pitchering%20pero%20tengo%20dudas!"
                      className="underline"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                ...
                <div className="space-y-4 text-base md:text-lg">
                  {[
                    ...
                    <div key={index} className="flex flex-wrap  items-center text-center md:text-left">
                      <span className="text-black text-xs font-semibold flex-1 text-start">{item.name}</span>
                      <span className="text-red-600 font-bold text-end">(Valorado en {item.value})</span>
                    </div>
                  ))}
                </div>
