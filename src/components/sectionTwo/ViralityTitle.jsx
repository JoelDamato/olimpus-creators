export default function ViralityTitle() {
  return (
    <>
 <div className="flex items-center justify-center w-full mt-4 md:mt-9">
  ...
  <div className="w-3/4 md:w-2/3 flex flex-col items-center justify-start md:gap-6">
    <h1 className="text-[20px] text-start ml-[-15px] md:text-4xl font-bold font-cincel text-white" style={{textShadow: 'rgba(0, 0, 0, 0.59) 2px 1px 2px'}}>
      EL OLIMPO DE LA VIRALIDAD:
    </h1>
    <p className="text-[15px] text-start text-sm md:text-base text-white font-sans md:text-[30px] md:w-3/4" style={{textShadow: 'rgba(0, 0, 0, 0.59) 2px 1px 2px'}}>
